...
In this example, one of the (handful) of problems is that the total lack of whitespace
in the test file here slows down your comprehension.

Whitespace exists in code for the same reason it exists in written language - to help direct
the reader. Use it.
